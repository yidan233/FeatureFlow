...
CREATE INDEX IF NOT EXISTS idx_flag_configs_flag_env ON flag_configs(flag_id, environment_id);
CREATE INDEX IF NOT EXISTS idx_flag_configs_enabled ON flag_configs(is_enabled);
CREATE INDEX IF NOT EXISTS idx_rollout_rules_flag_config ON rollout_rules(flag_config_id);
CREATE INDEX IF NOT EXISTS idx_rollout_rules_priority ON rollout_rules(priority);
CREATE INDEX IF NOT EXISTS idx_audit_log_entity ON audit_log(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_audit_log_created ON audit_log(created_at);
CREATE INDEX IF NOT EXISTS idx_flag_evaluations_flag_env ON flag_evaluations(flag_key, environment_name);
CREATE INDEX IF NOT EXISTS idx_flag_evaluations_time ON flag_evaluations(evaluated_at);
...
DO $$ BEGIN
    CREATE TRIGGER update_flag_configs_updated_at BEFORE UPDATE ON flag_configs 
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
